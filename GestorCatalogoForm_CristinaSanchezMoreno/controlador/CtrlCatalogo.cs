...
namespace GestorCatalogoForm_CristinaSanchezMoreno.controlador
{
    internal static class CtrlCatalogo
    {
        ...
        // Funcion que guarda los datos generales de los artistas en el archivo.
        private static void EscribirArtista(Artista art, BinaryWriter buffOut)
        {
            ...
            buffOut.Write(art.Imagen);
        }
        // Funcion que guarda los datos especificos de cada clase de artistas
        ...
        // Funcion que extrae la información del artistaBanda del archivo
        private static ArtistaBanda LeerArtistaBanda(BinaryReader buffIn)
        {
            ...
            int imagen = buffIn.ReadInt32();

            return new ArtistaBanda(lstMiembros, numIntegrantes, nombreGrupo, anioInicios, discografia, numDiscos,
                genero, estaActivo, imagen);
        }
        // Funcion que extrae la información del artistaSolista del archivo
        private static ArtistaSolista LeerArtistaSolista(BinaryReader buffIn)
        {
            ...
            return new ArtistaSolista(nombreReal, instrumentoPrincipal, nombreGrupo, anioInicios, discografia,
                numDiscos, genero, estaActivo, imagen);
        }
        // Funcion que extrae la informacion de los artistas en el archivo y nos lo introduce en una lista que retornará
        ...
        // Función que guarda con la que trabajamos en el archivo, usando las funciones que hemos creado anteriormente

...
{
    public partial class DarAltaBanda : Form
    {
        private static string rutaImagenOr;
        private FrmPrincipal frmPrincipal;
        public DarAltaBanda(FrmPrincipal frmPrincipal)
        {
            InitializeComponent();
        ...
        private void AddArtistaBandaToList()
        {
            String nombre;
            String anioInicios;
            ...
            lstMiembros = txtLstMiembros.Text;
            numIntegrantes = txtNumIntegrantes.Text;
            if (!int.TryParse(numIntegrantes, out numIntegrantesToInt))
            {
                datosCorrectos = false;
                mensajeError += "| numero de integrantes |";
            }

            if (datosCorrectos)
            {
                CtrlArtista.addArtistaBanda(new ArtistaBanda(lstMiembros, numIntegrantesToInt, nombre, anioiniciosToInt, discografica, numDiscosToInt, genero, estaActivo, idImagen));
        ...
        private void borrarCampos()
        {
            ...
            rbNo.Checked = false;
            rbSi.Checked = false;
            txtLstMiembros.Text = string.Empty;
            txtNumIntegrantes.Text = string.Empty;
            pbImagen.Image = null;
